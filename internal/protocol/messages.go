...
const (
	// GeneratedFallbackPromptPrefix identifies the prompt-less child-session
	// fallback generated by the CLI. It also lets the daemon make that
	// generated context visible in the persisted lifecycle summary.
	GeneratedFallbackPromptPrefix          = "You were created by "
