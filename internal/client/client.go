...
// dialLocalDaemon dials the local daemon's Unix socket. It is a package var so
// approval-connection tests can substitute an in-memory pipe and exercise the
// post-handshake operation deadline deterministically (issue #1251).
