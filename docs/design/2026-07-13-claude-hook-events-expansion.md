...
> **Security amendments (2026-07-18 and 2026-07-22):** Approval/Yolo/
> `approve-request` sections in this historical hook analysis were superseded
> by [Non-interactive agents with sandbox-enforced policy](2026-07-18-non-interactive-sandbox-policy.md),
> and all command-policy sections were subsequently superseded by
> [Remove Command Policy](2026-07-22-command-policy-removal.md).
...
> does not observe or answer that TUI. Generic lifecycle hooks remain; Graith no
> longer installs a semantic shell-command policy hook.
