...
**This code cannot be built here** (macOS host without iOS SDK/simulator and no
signing). It is implemented to spec and self-reviewed. Everything a human must
build and test in Xcode on a Mac is tracked in
