...
final class GhosttyTerminalNSView: BaseTerminalNSView {
    ...
    override init(sessionID: String, client: GraithProtocolClient, fontSize: CGFloat = Theme.defaultFontSize) {
        self.cellFont = Theme.terminalFont(ofSize: fontSize)
        super.init(sessionID: sessionID, client: client, fontSize: fontSize)
    }
...
struct GhosttyTerminalPane: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> GhosttyTerminalNSView {
        let view = GhosttyTerminalNSView(sessionID: sessionID, client: client, fontSize: fontSize)
