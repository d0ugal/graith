            ...
            Section {
                ...
                case let .available(catalog):
                    if catalog.names.isEmpty {
                        ...
                        Text("This host did not report any configured agents.")
                            .font(.caption)
                            .foregroundStyle(Theme.overlay0)
                    } else {
                ...
                Text("Each host supplies its own catalog and default. "
                     + "A local override is used only when that host offers it.")
                    .font(.caption)
                    .foregroundStyle(Theme.overlay0)
            }
        }
