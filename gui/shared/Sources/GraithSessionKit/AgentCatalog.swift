...
/// shows unavailable and leaves create requests free to send an empty `agent`
/// value so the daemon resolves its own default. This prevents a client-side
/// list from drifting from the selected host's effective `[agents.*]`
/// configuration.
