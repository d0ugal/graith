...
enabled backend or configured command policy is unavailable, creation fails;
an explicitly disabled sandbox is allowed with the normal startup warning and
