...
Hugo, k6, govulncheck, GoReleaser, Gitleaks, and TruffleHog CI tool pins live in
...
managers. k6, Gitleaks, and TruffleHog keep each image tag and digest in one
value so Renovate updates the image reference as a single integrity unit.
