...
- **[Monitoring & interaction]({{< relref "monitoring.md" >}})** — session lists, conversation search, event streams, token usage, observability helpers, logs, doctor, and driving a running session.
...
- **[Daemon & other commands]({{< relref "daemon.md" >}})** — daemon lifecycle, agent introspection, config, completion, command discovery, and internal commands.
